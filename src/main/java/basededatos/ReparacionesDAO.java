...
public class ReparacionesDAO extends BaseHibernateDAO {
	...
	// property constants
	public static final String FECHA_REPARACION = "fechaReparacion";
	public static final String HORA_REPARACION = "horaReparacion";
	...
	public List findByFechaReparacion(Object fechaReparacion) {
		return findByProperty(FECHA_REPARACION, fechaReparacion);
	}

	public List findByHoraReparacion(Object horaReparacion) {
		return findByProperty(HORA_REPARACION, horaReparacion);
	}
