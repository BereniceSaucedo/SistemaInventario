...
public class EstadoDAO extends BaseHibernateDAO {
	...
	public Estado findById(java.lang.Integer id) {
		...
		try {
			Estado instance = (Estado) getSession().get(
					"basededatos.Estado", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Estado instance) {
		...
		try {
			List results = getSession()
					.createCriteria("basededatos.Estado")
	...
	public List findByNombreEquipo(Object nombreEquipo) {
		return findByProperty(NOMBRE_EQUIPO, nombreEquipo);
	}
